...
static const struct UVC_FRAME_UNCOMPRESSED(6) uvc_frame_yuv_480p = {
	...
	.dwMinBitRate		= cpu_to_le32(614400),
	...
	.dwFrameInterval[4]	= cpu_to_le32(2000000),
	.dwFrameInterval[5]	= cpu_to_le32(10000000),	
};


static const struct UVC_FRAME_UNCOMPRESSED(6) uvc_frame_yuv_550p = {
	.bLength		= UVC_DT_FRAME_UNCOMPRESSED_SIZE(6),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_UNCOMPRESSED,
	.bFrameIndex		= 3,
	.bmCapabilities		= 0,
	.wWidth			= cpu_to_le16(640),
	.wHeight		= cpu_to_le16(550),
	.dwMinBitRate		= cpu_to_le32(704000),
	.dwMaxBitRate		= cpu_to_le32(21120000),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(704000),
	.dwDefaultFrameInterval	= cpu_to_le32(333333),
	.bFrameIntervalType	= 6,
	.dwFrameInterval[0]	= cpu_to_le32(333333),
	.dwFrameInterval[1]	= cpu_to_le32(500000),
...
static const struct UVC_FRAME_MJPEG(6) uvc_frame_mjpg_480p = {
	.bLength		= UVC_DT_FRAME_MJPEG_SIZE(6),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_MJPEG,
	.bFrameIndex		= 1,
	.bmCapabilities		= 0,
	...
	.wHeight		= cpu_to_le16(480),
	.dwMinBitRate		= cpu_to_le32(614400),
	.dwMaxBitRate		= cpu_to_le32(13824000),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(614400),
	.dwDefaultFrameInterval	= cpu_to_le32(333333),
	.bFrameIntervalType	= 6,
	.dwFrameInterval[0]	= cpu_to_le32(333333),
...
static const struct UVC_FRAME_MJPEG(6) uvc_frame_mjpg_550p = {
	.bLength		= UVC_DT_FRAME_MJPEG_SIZE(6),
	.bDescriptorType	= USB_DT_CS_INTERFACE,
	.bDescriptorSubType	= UVC_VS_FRAME_MJPEG,
	.bFrameIndex		= 3,
...
static const struct uvc_descriptor_header * const uvc_fs_streaming_cls[] = {
	...
	(const struct uvc_descriptor_header *) &uvc_frame_yuv_550p,	
	(const struct uvc_descriptor_header *) &uvc_frame_yuv_720p,
	(const struct uvc_descriptor_header *) &uvc_format_mjpg,
	(const struct uvc_descriptor_header *) &uvc_frame_mjpg_480p,		
	(const struct uvc_descriptor_header *) &uvc_frame_mjpg_360p,
	(const struct uvc_descriptor_header *) &uvc_frame_mjpg_550p,		
